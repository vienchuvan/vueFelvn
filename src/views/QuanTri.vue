<template>
    <div class="min-h-screen bg-slate-50 flex font-sans text-gray-900 selection:bg-blue-500 selection:text-white">
        <!-- LOGIN -->
            ...
            <div
                ...
                <form @submit.prevent="login" class="space-y-5">
                    <div>
                        ...
                        <input type="text" required value="admin@levietnam.com.vn"
                    ...
                    <div>
                        ...
                        <input type="password" required value="admin123"
                            class="w-full border border-gray-300 rounded-xl p-3 outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm" />
                    </div>
        ...
        <template v-else>
            <!-- SIDEBAR -->
            <aside class="w-64 bg-[#0a203f] text-gray-300 flex flex-col fixed h-full z-20 shadow-2xl">
                ...
                <div class="p-4 border-t border-white/10 text-xs text-center text-gray-500 shrink-0">
                ...
                <header
                    ...
                    <div class="flex items-center gap-4">
                        <button class="relative p-2 text-gray-400 hover:text-blue-600 transition-colors">
                            ...
                            <span
                                class="absolute top-1 right-1.5 w-2 h-2 bg-red-500 rounded-full border-2 border-white"></span>
                        </button>

                        <div class="flex items-center gap-2 pl-4 border-l border-gray-200 cursor-pointer">
                            <div
                    ...
                    " class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                                <table class="w-full text-left border-collapse">
                                    ...
                                    <tbody>
                                        <tr v-for="news in currentItems" :key="news.id"
                                ...
                                <div class="p-4 border-t border-gray-100 flex items-center justify-between">
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <button @click="nextPage" class="px-3 py-1 border rounded">Sau</button>
                                    </div>
                                </div>
                            </div>
                        </template>
