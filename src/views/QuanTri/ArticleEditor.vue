  ...
  <div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
      <div class="flex items-center gap-3">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Thêm / Sửa Bài Viết</h2>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-1 space-y-6">
        ...
        >
          <h3 class="font-bold text-gray-800 mb-4 border-b pb-2">Thuộc tính bài viết</h3>
...
<script>
import { Save, Image as ImageIcon, ChevronRight } from "lucide-vue-next";
export default {
  name: "ArticleEditor",
  components: {
    Save,
  ...
  methods: {
    ...
    extraAllowedContent: '*(*);*{*};*[*]',
      ...
      // set data
      this.ckEditor.setData(this.form.content[this.activeLang] || "");

      // sync realtime
      this.ckEditor.on("change", () => {
        this.form.content[this.activeLang] = this.ckEditor.getData();
      });
    },
    ...
    async submitArticle() {
      try {
        ...
        alert(isEdit ? "✅ Cập nhật bài viết thành công" : "✅ Đăng bài thành công");
