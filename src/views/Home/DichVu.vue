<template>
    <div class="services-page">
        ...
        <section class="relative w-full overflow-hidden border-b border-white/10">
            ...
            <!-- GLOW -->
            <div class="absolute top-[-120px] left-[-120px] w-[320px] h-[320px] bg-orange-500/20 blur-3xl rounded-full">
            </div>
            ...
            <div class="mx-auto max-w-[1180px] px-5">
                ...
                <div class="grid grid-cols-1 gap-7 lg:grid-cols-[1fr_300px]">
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <!-- CARD -->
                        <div v-for="(service, index) in services" :key="service.id" data-aos="zoom-in-up"
                            :data-aos-delay="index * 120" class="group service-card">
                            ...
                            <div class="p-5 text-left">
                                ...
                                <!-- DESC -->
                                <p class="mb-5 line-clamp-3 text-left text-[12.5px] leading-[1.9] text-[#6B7280]">
                                    {{ service.desc }}
                                </p>

                                <!-- BUTTON -->
                                <a :href="`/bai-viet/${service.slug}`" target="_blank"
                    ...
                    <aside data-aos="fade-left">
                        ...
                        <div class="sticky top-5 space-y-5">
                            ...
                            <div
                                ...
                                <!-- GLOW -->
                                <div class="absolute -top-12 -right-12 h-44 w-44 rounded-full bg-white/10 blur-3xl">
                                </div>
                                ...
                                <div class="relative z-10">
                                    ...
                                    <p class="mt-3 text-[13px] leading-[1.8] text-white/90">
                                        Đội ngũ tư vấn chuyên nghiệp của chúng tôi luôn sẵn sàng hỗ trợ doanh nghiệp của
                                        bạn.
                                    </p>
...
.services-page {
    ...
    background:
        linear-gradient(rgba(0, 0, 0, 0.04),
            rgba(0, 0, 0, 0.04)),
