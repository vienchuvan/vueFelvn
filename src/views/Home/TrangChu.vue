        ...
        <div class="lg:col-span-8">
          ...
          <section data-aos="fade-up"
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
              ...
              <div class="md:col-span-5">
                ...
                <div class="rounded-3xl overflow-hidden shadow-2xl floating-animation">

                  <img
                    src="https://images.unsplash.com/photo-1573164713988-8665fc963095?auto=format&fit=crop&q=80&w=800"
                    class="w-full h-60 object-cover transition-transform duration-700 hover:scale-110" alt="" />
          ...
          <section class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div v-for="(service, index) in featuredServices" :key="service.id" data-aos="zoom-in-up"
                :data-aos-delay="index * 120"
                class="group glow-orange bg-white rounded-[28px] overflow-hidden relative transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_25px_80px_rgba(0,0,0,0.2)]">
                ...
                <div class="p-6 flex flex-col h-[240px]">
                  ...
                  <div class="flex items-start gap-3 mb-4">
                    ...
                    <h3 class="text-left text-[#1d2454] text-[14px] font-extrabold leading-[1.6] line-clamp-2">
                      {{ getTitle(service) }}
                    </h3>

                  </div>

                  <p class="text-left text-[#6b7280] text-[13px] leading-[1.8] line-clamp-3 flex-1">
                    {{ getDescription(service) }}
                  </p>

                  <a :href="`/bai-viet/${service.slug}`"
                    class="group/link mt-5 inline-flex items-center gap-2 text-brand-orange text-[13px] font-bold">

                    Xem chi tiết

                    <i
                      class="fa-solid fa-arrow-right text-[11px] transition-transform duration-300 group-hover/link:translate-x-1"></i>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
              ...
              <div class="md:col-span-7">
                ...
                <div class="flex items-center gap-3 mb-5">
                  ...
                  <div class="w-14 h-14 rounded-2xl bg-white/15 backdrop-blur-xl flex items-center justify-center">
                ...
                <p class="text-white/95 text-[15px] leading-[1.9] font-medium max-w-[620px]">
                  Chương trình
                  <span class="font-black">
                    "Giao tiếp thấu cảm & Tạo ảnh hưởng"
                  </span>
                  giúp nâng cao hiệu quả làm việc, giải quyết rào cản đa văn hóa và chuẩn hóa kỹ năng giao tiếp số trong
                  thời đại mới.
                </p>
          ...
          <section class="space-y-7 mt-14">
            ...
            <div data-aos="fade-right" class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-4">
                ...
                <h2 class="text-white text-[26px] md:text-[32px] font-black tracking-tight">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div v-for="(item, index) in featuredNews" :key="index" data-aos="fade-up" :data-aos-delay="index * 150"
                ...
                <div class="p-5">
                  ...
                  <h3 class="text-left text-white text-[16px] font-extrabold leading-[1.7] line-clamp-2 min-h-[58px]">
                    {{ getTitle(item) }}
                  </h3>

                  <p class="mt-3 text-[#b9c6dc] text-left text-[13px] leading-[1.8] line-clamp-3 min-h-[72px]">
                    {{ getDescription(item) }}
                  </p>
