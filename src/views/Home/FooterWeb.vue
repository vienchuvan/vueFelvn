<template>
  ...
  <footer class="bg-[#020617] border-t border-white/10 py-16">
    <div
      class="max-w-[1180px] mx-auto px-5 grid grid-cols-1 md:grid-cols-3 gap-12"
    >
      <!-- Cột 1 -->
      <div class="space-y-4">
   ...
   <div
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-3 text-gray-400 text-sm text-left" >
          ...
          <li>
            <i
              class="fa-solid fa-phone mr-2 text-brand-orange"
            ></i>
          ...
          <li>
            <i
              class="fa-solid fa-envelope mr-2 text-brand-orange"
            ></i>
          ...
          <li>
            <i
              class="fa-solid fa-clock mr-2 text-brand-orange"
            ></i>
    ...
    <!-- COPYRIGHT -->
    <div
      class="max-w-[1180px] mx-auto px-5 mt-12 pt-8 border-t border-white/5 text-center text-gray-500 text-xs"
    >
      © 2026
      {{ currentLang.companyName || "LE VIET NAM" }}.
      Bảo lưu mọi quyền.
