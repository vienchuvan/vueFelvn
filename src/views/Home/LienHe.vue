<template>
  <div class="news-page-bg min-h-screen">
    ...
    >
      ...
      <!-- ORANGE GLOW -->
      <div
        class="absolute -left-24 top-10 h-[320px] w-[320px] rounded-full bg-orange-500/20 blur-3xl"
      ></div>
      ...
      <div class="relative z-10 mx-auto max-w-7xl px-4 py-14">
        ...
        <div class="grid grid-cols-1 gap-7 lg:grid-cols-[1fr_320px]">
          ...
          <div
            data-aos="fade-up"
            class="overflow-hidden rounded-[28px] border border-white/10 bg-white/95 backdrop-blur-xl shadow-[0_20px_70px_rgba(0,0,0,0.18)]"
          ...
          >
            <div class="grid grid-cols-1 lg:grid-cols-[320px_1fr]">
              ...
              >
                <!-- DECOR -->
                <div
                  class="absolute -bottom-16 -left-16 h-[220px] w-[220px] rounded-full bg-white/5"
                ></div>
                ...
                <div class="relative z-10 flex h-full flex-col">
                  ...
                  <div class="space-y-7">
                    ...
                    >
                      ...
                      >
                        <i
                          class="fa-solid fa-location-dot text-[20px] text-[#FF7A1A]"
                        ></i>
                      </div>
                    ...
                    >
                      ...
                      >
                        <i
                          class="fa-solid fa-phone-volume text-[18px] text-[#FF7A1A]"
                        ></i>
                      </div>
                  ...
                  <div class="mt-auto pt-8">
                    <div
                      class="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-xl"
                    >
                      <p
                        class="mb-2 text-[11px] font-bold uppercase tracking-[2px] text-white/50"
                      >
                  ...
                  <div>
                    ...
                    <div class="input-wrap">
                      ...
                      <select v-model="form.service" class="modern-input">
                        ...
                        <option>Giấy phép lao động</option>

                        <option>Visa - Thẻ tạm trú</option>
...
export default {
  ...
  methods: {
    async submitContact() {
      ...
      try {
        const res = await axios.post("https://miraivietnam.com/api/quantri/contacts", {
          idFun: 111,
